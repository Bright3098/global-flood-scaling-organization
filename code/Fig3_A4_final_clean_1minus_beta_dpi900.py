...
FIG_DIR = ROOT_DIR / "_figures_fig3_A4_final_clean_1minus_beta"
...
ax_a.text(-0.14, 1.05, "a", fontsize=11, fontweight="bold", transform=ax_a.transAxes)
...
ax_b1.text(-0.44, 1.05, "b", fontsize=11, fontweight="bold", transform=ax_b1.transAxes)
...
ax_c1.text(-0.42, 1.05, "c", fontsize=11, fontweight="bold", transform=ax_c1.transAxes)
...
ax_d1.text(-0.42, 1.05, "d", fontsize=11, fontweight="bold", transform=ax_d1.transAxes)
...
ax_e.text(-0.14, 1.05, "e", fontsize=11, fontweight="bold", transform=ax_e.transAxes)
...
ax_f.text(-0.14, 1.05, "f", fontsize=11, fontweight="bold", transform=ax_f.transAxes)
...
for ext in ["pdf", "png", "svg"]:
    out = FIG_DIR / f"Fig3_A4_final_clean_1minus_beta_no_arrow_scale_mode_heatmap.{ext}"
    if ext == "png":
